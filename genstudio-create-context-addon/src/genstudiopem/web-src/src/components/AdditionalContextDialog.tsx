...
import { Provider, defaultTheme, Flex, Item, Divider, SearchField, Checkbox, Key, Button, Picker } from '@adobe/react-spectrum';
...
export default function AdditionalContextDialog(): JSX.Element {
  ...
  const addToAdditionalContext = async () => {
    ...
    // await guestConnection.host.api.create.updateCustomPrompt(AdditionalContextTypes.Claims, selectedClaims);
  };
      ...
      <Flex direction="column" gap="size-300">
        ...
        <Flex direction="row" gap="size-100" justifyContent="end">
          ...
          <Button
            variant="primary"
            style="fill"
            onPress={addToAdditionalContext}
          >
            Select
          </Button>
        </Flex>
